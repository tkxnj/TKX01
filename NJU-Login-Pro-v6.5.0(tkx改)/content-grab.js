    ...
    <div class="nju-grab-status-body" data-nju-grab-status-body hidden>
       ...
       <div class="nju-grab-command-bar" data-nju-grab-command-bar>
          ...
          <label>间隔 <select data-nju-grab-interval aria-label="监控间隔">
            <option value="1000">1 秒</option><option value="2000">2 秒</option><option value="3000">3 秒</option><option value="5000">5 秒</option><option value="10000">10 秒</option><option value="30000">随机 1~3s</option>
          </select></label>
